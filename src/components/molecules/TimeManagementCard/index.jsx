  ...
  return (
    <div className="max-w-xs w-[400px] h-[350] p-6 mb-3 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 flex-shrink-0 overflow-hidden">
      <div className="flex flex-col h-full">
        <h2 className="text-xl font-bold text-secondary mb-auto text-center overflow-hidden ">
          {task}
        </h2>
        <span className="text-primary font-bold mb-2 mt-2 text-center uppercase ">
          {priority}
        </span>
